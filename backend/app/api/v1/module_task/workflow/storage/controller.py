...
async def list_storage_file_controller(
    ...
    result = await StorageFileService(auth, db).list_files(
...
async def list_storage_buckets_controller(
    ...
    result = await StorageFileService(auth, db).list_buckets(source_id=source_id)
...
async def rename_storage_file_controller(
    ...
    result = await StorageFileService(auth, db).rename(
...
async def mkdir_storage_file_controller(
    ...
    result = await StorageFileService(auth, db).mkdir(source_id=source_id, remote_dir=remote_dir, bucket=bucket)
...
async def share_storage_file_controller(
    ...
    result = await StorageFileService(auth, db).share(
