...
from app.api.v1.module_task.workflow.core.base import StorageAdapterConfig
from app.api.v1.module_task.workflow.core.factory import StorageAdapterFactory
...
from app.api.v1.module_task.workflow.transfer.registry import transfer_task_registry
from app.api.v1.module_task.workflow.transfer.ws_manager import transfer_ws_manager
from app.core.database import async_db_session
from app.core.logger import logger

from .model import StorageTransferStepModel, StorageTransferTaskModel
from .schema import TransferStepOutSchema, TransferTaskOutSchema
...
async def _broadcast(task: StorageTransferTaskModel, steps: list[StorageTransferStepModel]) -> None:
    # 进度广播是尽力而为：WS 抖动/客户端断连不得中断传输流水线本身
    try:
...
async def _run_step(db: AsyncSession, task: StorageTransferTaskModel, step: StorageTransferStepModel) -> bool:
    ...
    try:
        ...
        if step.transfer_mode:
            dst_config.transfer_mode = step.transfer_mode
