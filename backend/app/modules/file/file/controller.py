...
from fastapi import APIRouter, BackgroundTasks, Body, File, Form, Query, Request, Security, UploadFile
...
FileRouter = APIRouter(route_class=OperationLogRoute, tags=["文件管理"])
